  ...
  const render = (state) => {
    ...
    let html = `
      <div class="sidebar-brand" style="display: flex; align-items: center; gap: 0.65rem; padding: 1rem 0.75rem;">
        <img src="assets/logo.png?v=${window.APP_VERSION || '1'}" alt="Logo" style="width: 32px; height: 32px; border-radius: 6px; box-shadow: 0 2px 8px rgba(0,0,0,0.08); background: #ffffff; padding: 2px; border: 1px solid rgba(0,0,0,0.06);" />
